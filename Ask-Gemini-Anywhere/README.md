...
A userscript that allows you to quickly send page content to Gemini for analysis, summary, or translation.
...
- Gemini will summarize the content of the clicked element.
...
- Gemini will explain the selected text based on the context you clicked.
...
- Then you can type your keyword (e.g., `g`) followed by your query in the address bar to directly send it to Gemini.
